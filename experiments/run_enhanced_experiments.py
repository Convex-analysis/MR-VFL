...
def main():
    ...
    if args.experiment in ["all", "comparison"]:
        ...
        comparison_results = run_enhanced_comparison(
    ...
    if args.experiment in ["all", "streaming"]:
        ...
        streaming_results = run_enhanced_streaming_scenario(
    ...
    if args.experiment in ["all", "dynamic"]:
        ...
        dynamic_results, phase_performances = run_enhanced_dynamic_scenario(
